...
For both of us this work is personal.
...
We want an attendee in a small town in Kerala to feel, deep down:
...
The core product will remain the same: **A single, well-designed session that makes something click in an attendee’s mind and gives them tools to actually act on it.**

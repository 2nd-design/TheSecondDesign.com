...
export const sessions: Session[] = [
  {
    ...
    problemStatement: 'Students fear imperfection and cannot start.',
    whatStudentsDo:
  ...
  },
  {
    ...
    status: 'open-source',
    group: 'ready-and-tested',
    problemStatement: 'Students passively wait for opportunities instead of creating them.',
    whatStudentsDo:
  ...
  },
  {
    ...
    status: 'ready',
    group: 'ready-and-tested',
    problemStatement: "Students don't know how to intentionally shape their career path.",
    whatStudentsDo:
      'Apply agency thinking to career decisions. Design experiments to test career hypotheses. Build a personal action roadmap.',
    why: 'Career design is a system, not a lottery. Students practice treating it that way.',
    isOpenSource: false,
    order: 3,
  },
  {
    ...
    status: 'ready',
    group: 'ready-and-tested',
    problemStatement: 'Students face paralysis when thinking about life after college.',
    whatStudentsDo:
  ...
  },
  {
    ...
    status: 'ready',
    group: 'ready-and-tested',
    problemStatement: 'Students see career and life as random events, not interconnected systems.',
    whatStudentsDo:
      'Break down how systems work in real contexts. Apply systems thinking to their own decisions and projects.',
    why: 'Seeing patterns changes how students make choices.',
    isOpenSource: false,
    order: 5,
  },
  {
    ...
    status: 'upcoming',
    group: 'upcoming',
    problemStatement: 'Students struggle with too many options and no framework for choosing.',
    upcomingTeaser:
      "We're building this because students struggle with deciding what matters most when everything feels urgent.",
    isOpenSource: false,
    order: 1,
  },
];
